...
const SkeletonPeopleYouMayKnow = () => {
  return (
    <div className='container-people-you-may-know' id='no-bg-in-skeleton-load'>
        <Link className='text-decoration-none-in-container-people-you-may-know' id='fix-container-img'>
        ...
        <Link className='text-decoration-none-in-container-people-you-may-know' id='fix-container-fullname'>
